...
const PlacementLayout = () => {
  ...
  const navItems = [
    ...
    { name: "Opportunities", path: "/placement/opportunities", icon: Briefcase },
    { name: "Students", path: "/placement/students", icon: Users },
    { name: "Requests", path: "/placement/requests", icon: FileText },
  ];

  // Extract the current page from the path for breadcrumb
      ...
      <header className="sticky top-0 z-30 bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <NavLink to="/placement/dashboard" className="flex items-center gap-2">
              <span className="font-bold text-xl text-placement-primary">Training</span>
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-4 md:p-6 overflow-y-auto bg-gray-50">
          ...
          <div className="mb-4 flex items-center text-sm text-gray-500">
            ...
            <span className="font-medium text-gray-900">{getCurrentPageName()}</span>
          </div>
